  ...
  return (
    <div className="min-h-screen bg-[#0b0b0b] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-10 text-center">
        ...
        <h1 className="mt-7 text-5xl font-semibold">
      ...
      <section className="mx-auto mt-16 max-w-6xl px-6">
        <div className="rounded-3xl border border-gray-500 bg-[#111111] px-10 py-10">
          ...
          <div className="mt-5 space-y-5 text-base leading-7 text-gray-500">
            ...
            <p>
              ...
              across the country. We stock electronics, fashion, jewelry,
              and everyday essentials — all at prices that don't require
              a second mortgage.
            </p>
      ...
      <section className="mx-auto mt-12 max-w-6xl px-6 pb-20">
        <div className="rounded-3xl border border-lime-900 bg-[#111111] px-6 py-10 text-center">
          ...
          <button onClick={toShop} className="mt-6 rounded-xl bg-main-color px-8 py-4 font-semibold text-black">
            Browse Products&nbsp; →
          </button>
        </div>
      </section>
