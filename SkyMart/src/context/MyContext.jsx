...
export const ContextProvider = ({ children }) => {
  ...
  const [productsData, setProductsData] = useState([
    ...
    },
    {
      ...
      category: "electronics",
      image:
        "https://images.unsplash.com/photo-1706275399524-813e89914e43?w=400",
      rating: {
        rate: 4.3,
        count: 203,
      },
    ...
    },
    {
      ...
      category: "electronics",
      image:
        "https://images.unsplash.com/photo-1606230962358-1ba839e6e4aa?w=400",
      rating: {
        rate: 4.2,
        count: 167,
      },
  ...
  const incrCartItems = (id) => {
    showNotification("Quantity updated!");

    let cart = cartItems.map((elem) =>
  ...
  const addToCart = (product) => {
    ...
    let cart = [...cartItems, { ...product, quantity: 1 }];

    saveLocal("sm_cartItems", cart);
    setCartItems(cart);
  };
  ...
  const registerUser = (user) => {
    ...
    let register = [...userData, user];
    saveLocal("sm_users", register);
